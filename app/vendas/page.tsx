            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mt-6">
                ...
                >
                  ...
                  <Link href="/pagamentos" className="flex items-center justify-between w-full mt-6 pt-4 border-t border-slate-100 dark:border-slate-800 text-sm font-bold text-[#137fec] hover:text-blue-700 transition-colors group">
                ...
                >
                  ...
                  <Link href="/analytics" className="flex items-center justify-between w-full mt-6 pt-4 border-t border-slate-100 dark:border-slate-800 text-sm font-bold text-[#137fec] hover:text-blue-700 transition-colors group">
